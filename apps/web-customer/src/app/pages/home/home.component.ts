...
@Component({
  ...
  template: `
    <div class="relative min-h-screen bg-deep-ocean text-neutral-charcoal overflow-x-hidden pb-10">
...
export class HomeComponent implements OnInit {
  ...
  constructor(private productService: ProductService, public ts: TranslationService) {}
