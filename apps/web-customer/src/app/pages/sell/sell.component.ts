      ...
      <section class="w-full px-6 py-24">
         ...
         <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div class="space-y-4 text-center p-6 bg-white border border-neutral-200 rounded-lg shadow-sm hover:shadow-md transition-shadow">
               ...
               <p class="text-neutral-600 text-sm leading-relaxed">We empower local vendors first. Join a community that values local craftsmanship and sustainable growth.</p>
            </div>
         </div>
      </section>
    </div>
