...
export class PaymentPlanController {
  ...
  payInstallment(@Payload() data: { planId: string; installmentIndex: number; userId?: string }) {
    return this.paymentPlanService.payInstallment(data.planId, data.installmentIndex, data.userId);
  }
}
